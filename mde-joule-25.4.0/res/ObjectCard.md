			...
			"Sections": [
				{
					...
					"Card": {
						...
						"DetailImage": "/MDKSampleApp/Rules/ProductImage.js",
...
*/
export default function ProductImage(clientAPI) {
    var ImagePath = '/MDKSampleApp/Images/';
	ImagePath = String(ImagePath) + String(clientAPI.evaluateTargetPath("#Property:ProductId"));
	ImagePath = String(ImagePath) + String('.jpg');
	return ImagePath;
}
```
